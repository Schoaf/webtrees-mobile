/// Pulls a webtrees-contribution-request request id out of a shared "you got a response"
/// notification-email link, if it is one.
///
/// Matches the plain (non-"pretty") webtrees URL that email link uses —
/// `.../index.php?route=/module/_webtrees-contribution-request_/RequestReview/{tree}&id={id}`
...
int? shareReviewIdFromLink(Uri uri) {
  ...
  if (!RegExp(
    r'/module/_webtrees-contribution-request_/RequestReview/[^/]+$',
  ).hasMatch(route)) {
    return null;
  }
